...
// User Profiles (MySpace-style extended data)
...
// Tax Rates (live updated from external APIs)
...
export const usersRelations = relations(users, ({ one, many }) => ({
  ...
  tosAcceptance: one(tosAcceptances, {
    fields: [users.id],
    references: [tosAcceptances.userId],
  }),
  listings: many(marketplaceListings),
  geoVerification: one(geoVerifications, {
    fields: [users.id],
    references: [geoVerifications.userId],
  }),
...
export const geoVerificationsRelations = relations(geoVerifications, ({ one }) => ({
  user: one(users, {
    fields: [geoVerifications.userId],
    references: [users.id],
  }),
}));
