...
const resources = {
  en: {
    translation: {
      ...
      about: { title: 'About Us', subtitle: 'Passion for Anime & Gaming', desc: 'ラーメンアニメ is an online game shop run by a fellow anime fan and gamer. We create custom 3D printed anime merchandise and sell curated trading card collections on eBay. Every product is made and shipped with care by someone who genuinely loves this culture.', customers: 'Happy Customers', designs: '3D Print Designs', cardsListed: 'Cards Listed' },
      ...
      terms: { title: 'Terms of Service', acceptRequired: 'Terms of Service Required', acceptDesc: 'Before you can access the ラーメンアニメ Social Forum, you must read and accept our Terms of Service.', acceptBtn: 'I Accept the Terms', readFull: 'Read Full Terms' },
    }
  },
  ja: {
    translation: {
  ...
  fr: {
    translation: {
      ...
      about: { title: 'À Propos', subtitle: 'Passion pour l\'Anime et le Gaming', desc: 'ラーメンアニメ est une boutique en ligne dirigée par un fan d\'anime et gamer. Nous créons des articles anime imprimés en 3D et vendons des collections de cartes sur eBay.', customers: 'Clients Satisfaits', designs: 'Designs 3D', cardsListed: 'Cartes Listées' },
