...
echo "========================================"
echo "  Speed + Profile Save Fix"
echo "========================================"

# 1. Add aggressive caching to tRPC provider
cat << 'TRPCEOF' > src/providers/trpc.tsx
...
echo "[1/4] Fixed tRPC provider with aggressive caching"

# 2. Fix Profile page with debug logging and guaranteed save
...
echo "[2/4] Fixed Profile page with debug logging"

# 3. Also fix social-router to handle empty object properly
...
echo "[3/4] Fixed social-router.ts (accepts empty strings, filters them out)"

# 4. Commit and push
git add -A
git commit -m "fix: profile save + performance caching" && git push origin main || echo "Commit issue"
...
echo "2. Open your site in Chrome"
echo "3. Press F12 > Console tab"
echo "4. Try to create your profile"
echo "5. Watch for [Profile] messages in the console"
echo ""
echo "If you see [Profile] Save error: -> paste the error here"
echo "If nothing appears in console -> let me know"
echo "========================================"
