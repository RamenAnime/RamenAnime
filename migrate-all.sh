...
echo "Creating migration for ALL missing tables..."
...
git add api/boot.ts && git commit -m "fix: create ALL missing database tables" && git push origin main

echo ""
echo "Now deploy and visit:"
echo "  https://ramen-anime-denj.onrender.com/api/run-migration"
echo ""
echo "This will create all 11 tables including user_profiles."
echo "Then profile save, forum, friends, everything will work."
