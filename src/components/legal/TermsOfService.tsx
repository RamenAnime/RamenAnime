        ...
        <Accordion type="multiple" defaultValue={["item-1"]} className="space-y-2">
          ...
          <AccordionItem value="item-4" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-sm leading-relaxed space-y-3">
              ...
              <p><strong>4.6 Tax Compliance.</strong> Prices displayed on the marketplace may or may not include VAT/tax depending on your location. We automatically calculate and display applicable taxes based on the buyer's country using our Tax Engine. Sellers are responsible for remitting collected taxes to their local tax authorities. We provide transaction records to assist with tax reporting.</p>
